...
namespace _ProjectBooom_.DataStruct
{
    ...
    public class CaptchaInfo
    {
        ...
        {
            [SerializeField] [Header("验证码题目文本")] public string Answer;
            [SerializeField] [Header("验证码题目图片")] public Sprite Image;
            [SerializeField] [Header("验证码题目音频")] public AudioClip Audio;
        }
        ...
        [SerializeField] [Header("文本或图片或音频答案")]
